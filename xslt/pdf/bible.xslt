<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:template match="/usx" name="bible">
        <xsl:result-document method="html" href="{$bible_id}{$suffix}.html">
            ...
            <body class="scripture-styles lamedh" dir="{$metadata/data/alphabet/direction}" script="{$metadata/data/script}">
                    ...
                    <xsl:choose>
                        <xsl:when test="not($metadata/data/pod/description)">
                            <p>
                                ...
                                This Bible, and over a thousand others, are available in a variety of digital formats for free download at www.DBS.org.
                            </p>
                        </xsl:when>
                        <xsl:otherwise>
